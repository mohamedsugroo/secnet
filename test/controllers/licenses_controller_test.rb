...
class LicensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create license" do
    assert_difference('License.count') do
      post licenses_url, params: { license: { exdate: @license.exdate, lNumbe: @license.lNumbe, ltype: @license.ltype } }
    end
  ...
  test "should update license" do
    patch license_url(@license), params: { license: { exdate: @license.exdate, lNumbe: @license.lNumbe, ltype: @license.ltype } }
